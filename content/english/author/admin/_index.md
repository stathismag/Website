...
[[social]]
  icon = "envelope"
  icon_pack = "fas"
  link = "#contact"  # For a direct email link, use "mailto:smagerakis@upatras.gr".
...
<iframe src="/en/google_scholar_metrics.html" width="100%" height="145px" frameborder="0" scrolling="no" onload="this.style.height = this.contentWindow.document.documentElement.scrollHeight + 'px'"></iframe>
